export function RucaPattern() {
  return (
    ...
    >
      <defs>
        {/* Filtro de relieve para las rucas */}
      ...
      <pattern
        ...
        patternUnits="userSpaceOnUse"
      >
        {/* Ruca coral (offset para variedad) */}
        <use
          href="#ruca-shape"
          fill="none"
          stroke="#DE886C"
