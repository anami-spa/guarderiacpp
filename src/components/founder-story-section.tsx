      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">AGUÚ nace desde...</h2>
          ...
          <div className="bg-white/80 backdrop-blur p-8 md:p-10 rounded-3xl border-2 space-y-6 text-left">
            <p className="text-lg text-balance leading-relaxed">
              AGUÚ nace desde la experiencia real de una mamá que necesitó compatibilizar su desarrollo profesional con
            ...
            <p className="text-muted-foreground text-balance leading-relaxed">
              ...
              sea genuino y la comunicación sea cercana. Por eso creamos AGUÚ: un lugar donde las familias trabajadoras
